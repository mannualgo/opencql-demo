...
.stTabs [data-baseweb="tab"]{font-family:'Syne',sans-serif!important;font-size:12.5px!important;font-weight:600!important;color:#8899bb!important;padding:11px 18px!important;border-bottom:2px solid transparent!important;transition:all .15s}
.stTabs [data-baseweb="tab"]:hover{color:#c0d0e8!important}
.stTabs [aria-selected="true"]{color:#ffffff!important;font-weight:800!important;border-bottom:2px solid var(--blue)!important;background:transparent!important}
...
.stExpander{background:var(--panel)!important;border:1px solid var(--bdr)!important;border-radius:8px!important;overflow:hidden}
.stExpander summary{color:#e2e8f0!important;font-size:12px!important;font-family:"Syne",sans-serif!important;font-weight:600!important;padding:10px 14px!important;background:var(--panel)!important;list-style:none!important;cursor:pointer}
.stExpander summary:hover{background:var(--p2)!important}
.stExpander summary p{color:#e2e8f0!important;font-size:12px!important;font-family:"Syne",sans-serif!important;font-weight:600!important;margin:0!important;display:inline!important}
.stExpander [data-testid="stExpanderToggleIcon"]{color:#4a5a7a!important;flex-shrink:0}
.stExpander [data-testid="stExpanderDetails"]{background:var(--panel)!important;padding:10px 14px!important}
/* Fix icon+text overlap */
.stExpander summary > div{display:flex!important;align-items:center!important;gap:6px!important}
